...
export default function GigEdit() {
    ...
    useEffect(() => {
        async function getGigDetail() {
            await axios.post("http://localhost:3001/gigDetail", {
                headers: {
    ...
    const EditGigHandler = (e) => {
        ...
        console.log("editGig has been executed!");
    };
    ...
    return (
        <div id="gigCreationWindow" className="container justify-content-center mt-3">
            <div className="text-center">
                <h1 id="registerTitle">Gig Edit</h1>
            </div>
            <div>
                <Fragment>
            ...
            <Form className="w-100">
                ...
                <div className="d-grid gap-3 mt-5">
                    <button className="btn btn-outline-primary btn-lg w-100"
                        onClick={EditGigHandler}>Save</button>
                    <Link to="/bookingGigs" className="btn btn-outline-danger btn-lg">Back</Link>
                </div>
